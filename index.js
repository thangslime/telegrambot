...
app.post('/webhook', async (req, res) => {
    ...
    if (body.new_chat_member) {
      ...
      const user_name = `${newMember.first_name ? newMember.first_name : ''} ${newMember.last_name ? newMember.last_name : ''}`.trim()
      const data = {
      ...
      await axios.post(
        `https://api.telegram.org/bot${process.env.BOT_APIKEY || '6468513372:AAFVyJWK7R0lQ5CkYGPf0-t_hAR_qgjOF1o'}/sendMessage`,
        data
      );
    } else {
        const data = {
